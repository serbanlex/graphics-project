...
\textbf{Outfit:} Traditional white desert robes with headscarf (keffiyeh style)\\
\textbf{Pose:} Sitting on camel saddle, looking at camera\\
\textbf{Tool Used:} Nano Banana\\
\textbf{Observation:} Slight quality reduction observed during compositing compared to original Seedream 4.5 output.
...
\textbf{Outfit:} Mowgli/Tarzan jungle style — minimal clothing, bare chest, loincloth\\
\textbf{Pose:} Standing heroically on stone plateau, commanding presence\\
\textbf{Tool Used:} Nano Banana\\
\textbf{Note:} May require Flux Kontext refinement for seamless integration.

\subsubsection{Medieval — Hero Composite}

\todo{Add after generation}
