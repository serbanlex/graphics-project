...
\begin{lstlisting}[style=promptstyle]
Epic medieval castle courtyard at sunset, imposing fortress with flying heraldic banners, grand ceremony in progress, two formations of knights in shining armor flanking a crimson carpet, a regal king presenting a royal proclamation scroll to an empty space before him, a noble warhorse with ornate medieval saddle and golden bridles standing ready beside the king awaiting its rider, herald trumpeters announcing the moment, torchlight reflecting off armor, medieval nobility watching, dramatic clouds in the sky, wide cinematic landscape composition, photorealistic, 16:9 aspect ratio, 4K resolution, Lord of the Rings style epic fantasy
\end{lstlisting}

\subsubsection{Futuristic City Prompt}

\todo{Insert prompt after generation}
...
Medieval & Complete & medieval\_1.png & Awaiting rider (horse) \\
Futuristic & Pending & — & TBD \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{images/medieval_1.png}
\caption{Medieval castle courtyard ceremony with knights, king, and awaiting warhorse. Generated with Seedream 4.5 via lovart.ai.}
\label{fig:medieval}
\end{figure}

\textbf{World:} Medieval Town\\
\textbf{Tool(s) Used:} Seedream 4.5 (lovart.ai)\\
\textbf{Description:} Epic castle courtyard at sunset featuring two formations of knights in shining armor flanking a crimson carpet. A king presents a royal proclamation while a noble warhorse with ornate saddle awaits its rider — the hero spot for character insertion.
