...
\subsubsection{Edit Prompts Used}

The in-context editing phase utilized specific prompts designed to add story-critical elements while strictly maintaining the hero's identity and background integrity. Detailed prompts for all four worlds (Cyberpunk, Medieval, Jungle, and Desert) are documented in Section~\ref{sec:incontextprompts}.

For the direct tool comparison focused on in this section (Cyberpunk Hologram), the following prompt was applied:
